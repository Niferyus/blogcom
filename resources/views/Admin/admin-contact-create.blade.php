...
<form action="/admin-panel/admin-contact-create" method="POST">
    ...
    <div class="container">
        <div class="form-group">
            ...
            <textarea name="phonenumber" id="phonenumber" class="form-control" cols="30" rows="2"></textarea>
        </div>
        <div class="form-group">
            <label for="faxnumber" class="form-label">Fax Numaras</label>
            <textarea name="faxnumber" id="faxnumber" class="form-control" cols="30" rows="10"></textarea>
        </div>
        <div class="form-group">
            <label for="firstmail" class="form-label">Mail</label>
            <textarea name="firstmail" id="firstmail" class="form-control" cols="30" rows="1"></textarea>
        </div>
        <div class="form-group">
